...
* that that will use this class are a Splay Tree and a Hashtable. 
*
...
public:
	...
	* printed to a new line of the stream. The words appear in
	* alphabetical order, and the count is separated from the 
	* word by a space.
	*/
